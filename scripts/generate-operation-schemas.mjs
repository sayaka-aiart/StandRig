...
const program=ts.createProgram([file,'packages/core/src/qaCheck.ts','packages/core/src/motionTypes.ts'],{strict:true,target:ts.ScriptTarget.ES2022,module:ts.ModuleKind.NodeNext,moduleResolution:ts.ModuleResolutionKind.NodeNext,skipLibCheck:true});
